...
for ip3r_nr=[40,60]
for aa=frst:set_nr
    file_name=['coupl_rep_uncoupl_mult_clusters_Cannell_Cao_ryrs_',num2str(ryr_nr),'_ip3rs_',num2str(ip3r_nr),'_Tsim_3000smaller_set_test_v',num2str(aa),'_dist_1-8um_tr13_0st.mat'];
...
save(['gryr002_preliminary_tr13_ip3r',num2str(ip3r_nr),'_0_st_all_dyads.mat']);
end
disp('done')
