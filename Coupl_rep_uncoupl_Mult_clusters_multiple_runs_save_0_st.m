...
% Change the following two lines to '=2' instead of '=1' to start the
% simulation with triggered sparks at the two coupled dyads.
    RyR_sparse(1:30,2)=1; % state of each receptor
    RyR_sparse(div+1:div+30,2)=1; % state of each receptor
    RyR_sparse(4*div+1:4*div+30,2)=1; % state of each receptor
    RyR_sparse(5*div+1:5*div+30,2)=1; % state of each receptor
